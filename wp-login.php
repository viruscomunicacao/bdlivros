...
<html lang="pt-BR" id="html">
	...
	<title>Acessar &lsaquo; BD Livros &#8212; WordPress</title>
	<meta name="robots" content="max-image-preview:large, noindex, noarchive">
<link rel="dns-prefetch" href="//s.w.org">
<link rel="stylesheet" id="dashicons-css" href="./wp-includes/css/dashicons.min.css?ver=5.9.2" media="all">
<link rel="stylesheet" id="buttons-css" href="./wp-includes/css/buttons.min.css?ver=5.9.2" media="all">
<link rel="stylesheet" id="forms-css" href="./wp-admin/css/forms.min.css?ver=5.9.2" media="all">
<link rel="stylesheet" id="l10n-css" href="./wp-admin/css/l10n.min.css?ver=5.9.2" media="all">
<link rel="stylesheet" id="login-css" href="./wp-admin/css/login.min.css?ver=5.9.2" media="all">
	<meta name="referrer" content="strict-origin-when-cross-origin">
		<meta name="viewport" content="width=device-width">
	<link rel="icon" href="./wp-content/uploads/2022/03/BD_Livros-Logo-2-150x150.png" sizes="32x32">
<link rel="icon" href="./wp-content/uploads/2022/03/BD_Livros-Logo-2.png" sizes="192x192">
<link rel="apple-touch-icon" href="./wp-content/uploads/2022/03/BD_Livros-Logo-2.png">
<meta name="msapplication-TileImage" content="./wp-content/uploads/2022/03/BD_Livros-Logo-2.png">
	</head>
		...
		<form name="loginform" id="loginform" action="./wp-login.php" method="post">
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Acessar">
					...
					<p id="nav">
								<a href="./minha-conta/lost-password/index.html">Perdeu a senha?</a>
			</p>
					<script type="text/javascript">
...
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
				<p id="backtoblog">
			<a href="./index.html">&larr; Ir para BD Livros</a>		</p>
			</div>
...
<script src="./wp-admin/js/password-strength-meter.min.js?ver=5.9.2" id="password-strength-meter-js"></script>
<script src="./wp-includes/js/underscore.min.js?ver=1.13.1" id="underscore-js"></script>
<script id="wp-util-js-extra">
var _wpUtilSettings = {"ajax":{"url":"\/bdlivros\/wp-admin\/admin-ajax.php"}};
</script>
<script src="./wp-includes/js/wp-util.min.js?ver=5.9.2" id="wp-util-js"></script>
<script id="user-profile-js-extra">
var userProfileL10n = {"user_id":"0","nonce":"b7988684cf"};
</script>
...
<script src="./wp-admin/js/user-profile.min.js?ver=5.9.2" id="user-profile-js"></script>
			<script>
