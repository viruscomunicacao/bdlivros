...
<link rel="stylesheet" id="dashicons-css" href="./wp-includes/css/dashicons.min.css?ver=5.9" media="all">
<link rel="stylesheet" id="buttons-css" href="./wp-includes/css/buttons.min.css?ver=5.9" media="all">
<link rel="stylesheet" id="forms-css" href="./wp-admin/css/forms.min.css?ver=5.9" media="all">
<link rel="stylesheet" id="l10n-css" href="./wp-admin/css/l10n.min.css?ver=5.9" media="all">
<link rel="stylesheet" id="login-css" href="./wp-admin/css/login.min.css?ver=5.9" media="all">
...
<script src="./wp-admin/js/password-strength-meter.min.js?ver=5.9" id="password-strength-meter-js"></script>
...
var userProfileL10n = {"user_id":"0","nonce":"731e9b16f4"};
</script>
...
<script src="./wp-admin/js/user-profile.min.js?ver=5.9" id="user-profile-js"></script>
			<script>
